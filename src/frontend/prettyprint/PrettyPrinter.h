...
public:
  ...
  PrettyPrinter(std::ostream &os, char indentChar, int indentSize) : os(os), indentChar(indentChar), indentSize(indentSize) {}
  ...
  // Expressions that do not cause indentation
  virtual void endVisit(ASTArrayConstructorExpr *element) override;
  ...
  // Statements that cause indentation
