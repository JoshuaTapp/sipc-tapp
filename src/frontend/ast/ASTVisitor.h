...
public:
  ...
  /* New visit and endVisit methods for the new AST nodes for deliverable 2 */

  // ASTArrayConstructorExpr
  virtual bool visit(ASTArrayConstructorExpr *element) { return true; }
  virtual void endVisit(ASTArrayConstructorExpr *element) {}
  // ASTArrayLengthExpr
  ...
  virtual bool visit(ASTArraySubscriptExpr *element) { return true; }
  virtual void endVisit(ASTArraySubscriptExpr *element) {}
  // ASTBooleanExpr
  ...
  // ASTPostfixStmt
  virtual bool visit(ASTPostfixStmt *element) { return true; }
  virtual void endVisit(ASTPostfixStmt *element) {}
  // ASTTernaryExpr
