...
TEST_CASE("TypeConstraintVisitor: access expr", "[TypeConstraintVisitor]") {
  ...
  std::vector<std::string> expected{
      ...
      "\u27E6r@3:14\u27E7 = \u27E6{f:4,g:13}@4:14\u27E7", // assignment
      "\u27E6r@3:14\u27E7 = "
      "{f:\u03B1<(r.g):f>,g:\u27E6(r.g)@5:17\u27E7}",       // field access
      "\u27E6(r.g)@5:17\u27E7 = int",                       // main return int
      "\u27E6main@2:6\u27E7 = () -> \u27E6(r.g)@5:17\u27E7" // function
                                                            // decl
  };
...
main() {
  ...
  std::vector<std::string> expected{
      ...
      "\u27E6n@3:8\u27E7 = "
      "{a:\u03B1<(n.c):a>,b:\u03B1<(n.c):b>,c:\u27E6(n.c)@6:13\u27E7,d:\u03B1<("
      "n.c):d>}",                                                 // access
      "\u27E6(n.c)@6:13\u27E7 = \u2B61\u27E6(*(n.c))@6:11\u27E7", // assign
                                                                  // through ptr
      "\u27E6(*(n.c))@6:11\u27E7 = "
      "{a:\u27E6((*(n.c)).a)@6:10\u27E7,b:\u03B1<((*(n.c)).a):b>,c:\u03B1<((*("
      "n.c)).a):c>,d:\u03B1<((*(n.c)).a):d>}",               // access
